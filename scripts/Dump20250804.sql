...
INSERT INTO `students` VALUES (1,'Florentino Octavio','Mejia Rosales','FOMR26111983'),(2,'Irving','Padilla Soto','IRPA22111977'),(3,'Vulcan Francisco','Ignacio','IRPA22111977'),(4,'Nadia','Guzman E','NAGU02111789');
...
CREATE TABLE `students_calendars` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idStrudent` int(11) DEFAULT NULL,
...
-- Dump completed on 2025-08-04  0:16:45
